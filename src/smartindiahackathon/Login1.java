...
public class Login1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Lenovo\\Desktop\\d.jpeg")); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
		...
		{ 
			...
			String s="select * from slogin1 where username=? and password=? ";
			...
			try{
				...
				if(rs.next())
				{
					int y=JOptionPane.showConfirmDialog(null, "Welcome To Livestock Ownership Database ","Swings", JOptionPane.YES_NO_OPTION);
					if (y==0)
					{
